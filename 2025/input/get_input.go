...
func downloadFile(year int, day int, cookie string) error {
	...
	fmt.Printf("%d Day %d input downloaded successfully as %s\n", year, day, fileName)
	return nil
}
...
func main() {
	...
	yearFlag := flag.Int("year", 2025, "The year of the Advent of Code puzzles to download")

	flag.Parse()

	err = downloadFile(*yearFlag, *dayFlag, cookie)
	if err != nil {
